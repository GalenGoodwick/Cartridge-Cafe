    ...
    <main className="min-h-screen bg-void text-crema/80" style={{ background: 'radial-gradient(120% 90% at 50% 0%, #17100b 0%, #0b0908 60%)' }}>
      <div className="mx-auto max-w-2xl px-6 py-16 font-mono">
        ...
        <div className="rounded-xl border border-brass/40 bg-black/30 p-5 mt-6">
          ...
          <P><b className="text-glow">Want total IP control?</b> The <b>IP control membership</b> closes the source of every world you make &mdash; playable on the shelf, never readable, never reusable &mdash; and includes a custom company page. The deal above stops applying to your work the moment you hold it.</P>
        ...
        <P><b>IP control (premium):</b> holders&rsquo; worlds are excluded from the platform commons entirely — closed source even when public — and the membership includes a <b>custom company page</b> on the platform. While the membership lapses, worlds stay closed-source-by-you but new publishing falls under the standard commons deal.</P>
