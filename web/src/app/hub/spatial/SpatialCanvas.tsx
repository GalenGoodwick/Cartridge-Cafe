...
const SpatialCanvas = forwardRef<SpatialCanvasHandle, SpatialCanvasProps>(function SpatialCanvas({
  ...
  return (
    ...
    >
      ...
      {editMode && savedFields && savedFields.length > 0 && containerRef.current && (() => {
        ...
        return savedFields.map(field => {
          ...
          return (
            ...
            >
              <div
                className="absolute -top-5 left-0 text-[14px] font-mono truncate max-w-[120px] px-1 rounded"
          ...
          >
            ...
            >
              ...
              >
                ...
                />
                <span
                  className="text-[16px] font-mono uppercase tracking-wider"
              ...
              <div className="flex-1 px-2 py-2 space-y-1.5 overflow-hidden">
                {previews.length > 0 ? previews.slice(0, 4).map((title, i) => (
                  <div
                    key={i}
                    className="px-2 py-1.5 rounded text-[14px] font-serif leading-tight truncate"
                    style={{
                  ...
                  <div className="text-[14px] font-mono text-muted-light/30 text-center pt-4">
                    No items
                  </div>
                )}
              </div>
      ...
      {spatialMode === 'list' && listTab && (() => {
        ...
        if (items.length === 0) {
          return (
            ...
            >
              <div className="text-center text-[16px] font-mono text-muted-light/50 py-4">
            ...
            >
              ...
              >
                <div className="flex-1 px-2.5 py-2 min-w-0">
                  <div
                    className="text-[14px] font-serif leading-snug line-clamp-3"
                    style={{ color: '#cbd5e1' }}
                  >
                    {item.title}
                  </div>
                  {item.phase && (
                    <div
                      className="mt-1 text-[13px] font-mono uppercase tracking-wide"
              ...
              {hostNavState?.dockedPostId ? (
                <div className="flex items-center justify-between gap-2">
                  <div className="min-w-0">
                    <div className="text-[14px] font-mono text-muted-light/50 uppercase tracking-wider mb-0.5">Viewing</div>
                    <div className="text-[16px] font-serif text-foreground/80 truncate">
                      {hostNavState.dockedPostId}
                    </div>
                  </div>
                  <button
                    ...
                    className="shrink-0 px-2.5 py-1 rounded-md text-[14px] font-mono transition-all hover:scale-105"
                    style={{
                ...
                <div>
                  <div className="text-[14px] font-mono text-muted-light/50 uppercase tracking-wider mb-0.5">Browsing</div>
                  <div className="text-[16px] font-mono capitalize" style={{ color: dockedPlayer.color }}>
                    {hostNavState.activeTab}
                  </div>
                </div>
              ) : (
                <div className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-[16px] font-mono text-muted-light/50">
      ...
      <div className="absolute bottom-3 right-3 text-[14px] font-mono text-muted-light/30 pointer-events-none">
        ...
        <div className="absolute bottom-3 left-3 pointer-events-auto" data-spatial-frame>
          <div className="bg-background/80 backdrop-blur-sm border border-border/50 rounded-lg p-3 max-w-[220px] max-h-[50vh] overflow-y-auto">
            ...
            <button
              ...
              className={`w-full text-[14px] font-mono py-1.5 px-2 rounded border transition-colors mb-2 flex items-center justify-center gap-1.5 ${
                editMode
            ...
            {editMode && editSelectedId && (() => {
              ...
              return (
                <div className="mb-2 p-2 rounded border border-border/50 bg-background/50">
                  <p className="text-[14px] font-mono truncate mb-1.5" style={{ color: fieldColor }}>
                    {selectedField.name}
                  </p>
                  <label className="flex items-center justify-between text-[14px] font-mono text-muted mb-1">
            ...
            {/* Active backdrop */}
            <p className="text-[14px] font-mono text-muted uppercase tracking-wider mb-1.5">Active Backdrop</p>
            {savedFields && savedFields.length > 0 ? (
              <div className="flex flex-col gap-1 mb-3">
                {savedFields.map(f => (
                  <div key={f.id} className="flex items-center justify-between gap-2 text-[16px]">
                    <span
                      className="truncate"
              ...
              <p className="text-[14px] text-muted mb-3">No backdrop fields active.</p>
            )}
            ...
            <div className="border-t border-border/50 pt-2 flex flex-col gap-1.5">
              <button
                ...
                className="w-full text-[14px] font-mono py-1.5 px-2 rounded border border-accent/40 text-accent hover:bg-accent/10 transition-colors"
              >
                Browse Library ({fieldLibrary?.length || 0})
              </button>
              <button
                onClick={onImportAllFields}
                className="w-full text-[14px] font-mono py-1 px-2 rounded border border-accent/40 text-accent hover:bg-accent/10 transition-colors"
              >
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-3 px-4 py-3 border-b border-border/30 shrink-0">
              ...
              <span className="text-[14px] font-mono px-1.5 py-0.5 rounded bg-accent/15 text-accent">
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-2 mb-1.5">
                            ...
                            {isActive && (
                              <span className="text-[13px] font-mono px-1 py-0.5 rounded bg-success/15 text-success shrink-0">Active</span>
                            )}
                          </div>
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            {blendModes.map(b => (
                              <span key={b} className="text-[13px] font-mono px-1 py-0.5 rounded bg-background/80 text-muted/70">
                                {b}
                              </span>
                            ))}
                          </div>
                          {f.effects[0]?.description && (
                            <p className="text-[14px] text-muted/60 line-clamp-2 leading-snug">
                              {f.effects[0].description}
                            </p>
                          )}
                        </button>
                  ...
                  <div className="p-4 flex flex-col gap-3">
                    ...
                    {libraryDetailField.parentFieldId && (() => {
                      ...
                      return (
                        <button
                          ...
                          className="flex items-center gap-1.5 text-[14px] font-mono text-muted hover:text-foreground transition-colors"
                        >
                          <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path d="M15 19l-7-7 7-7" />
                          </svg>
                    ...
                    <div className="flex flex-col gap-1.5">
                      {savedFields?.some(sf => sf.id === libraryDetailField.id) ? (
                        <div className="text-[14px] font-mono py-1.5 px-2 rounded border border-success/30 text-success/70 text-center">
                          Already Loaded
                        </div>
                      ) : (
                        <button
                          onClick={() => onLoadFromLibrary?.(libraryDetailField.id)}
                          className="text-[14px] font-mono py-1.5 px-2 rounded border border-accent/40 text-accent hover:bg-accent/10 transition-colors"
                        >
                          Load to Backdrop
                        </button>
                      )}
                      <button
                        ...
                        className="text-[14px] font-mono py-1.5 px-2 rounded border border-error/30 text-error/70 hover:bg-error/10 transition-colors"
                      >
                        Remove from Library
                      </button>
                    </div>
                    ...
                    {/* Color RGBA */}
                    <div>
                      <p className="text-[14px] font-mono text-muted uppercase tracking-wider mb-1">Color</p>
                      <p className="text-[16px] font-mono text-foreground/70">
                    ...
                    {/* Transform */}
                    <div>
                      <p className="text-[14px] font-mono text-muted uppercase tracking-wider mb-1">Transform</p>
                      <div className="grid grid-cols-2 gap-x-3 gap-y-0.5 text-[14px] font-mono text-foreground/60">
                    ...
                    {libraryDetailChildren.length > 0 && (
                      <div>
                        <p className="text-[14px] font-mono text-muted uppercase tracking-wider mb-1.5">
                          ...
                          {libraryDetailChildren.map(child => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <span className="text-[14px] font-mono text-foreground/70 truncate">{child.name}</span>
                                <span className="text-[13px] font-mono text-muted ml-auto shrink-0">
                        ...
                        <div className="flex flex-col gap-2">
                          {libraryDetailField.effects.map(effect => (
                            <div key={effect.id} className="rounded border border-border/30 p-2 bg-background/30">
                              <div className="flex items-center gap-2 mb-1">
                                <span className="text-[14px] font-mono text-foreground/70">{effect.author}</span>
                                <span className="text-[13px] font-mono px-1 py-0.5 rounded bg-accent/10 text-accent/70">
                                  {effect.blend}
                                </span>
                              </div>
                              {effect.description && (
                                <p className="text-[14px] text-muted/60 mb-1.5 leading-snug">{effect.description}</p>
                              )}
                              <pre className="text-[14px] font-mono text-foreground/40 bg-background/50 rounded p-1.5 overflow-x-auto max-h-24 leading-tight">
                      ...
                      <div>
                        ...
                        <div className="flex flex-col gap-1 max-h-48 overflow-y-auto">
                          {[...libraryDetailField.memory].reverse().slice(0, 20).map((entry, i) => (
                            <div key={i} className="text-[14px] font-mono text-foreground/40 leading-snug">
