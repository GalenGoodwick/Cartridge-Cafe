...
const chip =
  'px-2.5 py-1.5 rounded-lg text-[14px] tracking-[0.15em] font-mono bg-black/60 ' +
  'backdrop-blur border border-white/10 text-white/70 hover:text-white hover:bg-black/80 transition-colors'
const chipHot =
  'px-2.5 py-1.5 rounded-lg text-[14px] tracking-[0.15em] font-mono bg-amber-400/15 ' +
        ...
        <div className="absolute right-3 top-3 z-40 flex flex-col items-end gap-1.5">
          ...
          {can(ctx, 'createBranch') && (
            <div className="flex flex-col items-stretch gap-1">
              <button className="px-2.5 py-1.5 rounded-lg text-[14px] tracking-[0.15em] font-mono bg-emerald-400/20 border border-emerald-300/50 text-emerald-200 hover:bg-emerald-400/30" onClick={host.onCreateBranch}>⑂ CREATE BRANCH</button>
              <div className="flex justify-between rounded-lg bg-black/60 border border-white/10">
                ...
                <span className="px-1 py-1 text-[14px] text-white/35 tracking-[0.25em]">BROWSE</span>
                <button className="px-2 py-1 text-white/45 hover:text-white" onClick={() => host.onBrowseBranch(1)}>▸</button>
              </div>
            </div>
          )}
