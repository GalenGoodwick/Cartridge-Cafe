...
page.on('console', m => { const t = m.text(); if (/arena|8080|error|fault|gpu/i.test(t)) console.log('console:', t.slice(0, 160)) })
await page.goto('http://localhost:3000/space/base-platformer-2d?room=fell', { waitUntil: 'domcontentloaded' })
