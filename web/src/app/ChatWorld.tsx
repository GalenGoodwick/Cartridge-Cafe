          ...
          <div className="mx-auto w-full max-w-[680px]">
            {connectable ? (
              <>
                ...
                <div className="rounded-lg bg-black/60 border border-brass/30 px-3 py-2.5 font-mono text-[10px] leading-relaxed text-glow/90 whitespace-pre-wrap select-all max-h-44 overflow-y-auto mb-2">
                  {connectPrompt()}
                </div>
