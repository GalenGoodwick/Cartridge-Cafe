...
const HEADLINE = `${BRAND} — little game worlds, brewed by AI`
const DESC = 'Little game worlds, brewed to order by AI — describe one, watch it built live, then play. Best on a desktop browser.'
