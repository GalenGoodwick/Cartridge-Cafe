...
page.on('console', m => { const t = m.text(); if (/mp-debug|arena|websocket/i.test(t)) console.log('console:', t.slice(0, 160)) })
await page.goto('http://localhost:3000/space/e2e-arena-ground', { waitUntil: 'domcontentloaded' })
