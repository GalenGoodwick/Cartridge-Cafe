  ...
  return (
    <main className="min-h-screen bg-void text-crema/80" style={{ background: 'radial-gradient(120% 90% at 50% 0%, #17100b 0%, #0b0908 60%)' }}>
      <div className="mx-auto max-w-2xl px-6 py-16 font-mono">
        ...
        <div className="text-[14px] tracking-[0.15em] text-crema/40 mb-2">last updated 2026-09-05</div>
        ...
        <div className="rounded-xl border border-brass/40 bg-black/30 p-5 mt-6">
          ...
          <P><b className="text-glow">Code on the free and editing tiers is open source.</b> The code of playable worlds &mdash; shaders, hooks, nodes &mdash; is readable by every member through the library, may be reused <b>inside other cartridge.cafe worlds</b>, and is <b>published on each world&rsquo;s public source page</b>, where anyone on the open web (including search engines) can find and read it. Attribution travels with it: lineage, version history, and the library record who made what. This is the commons that makes the cafe compound &mdash; and discoverable.</P>
          <P><b className="text-glow">Want copyright and confidentiality?</b> The <b>◆ IP control membership</b> ($100/mo, on the <Link href="/suite" className="text-brass hover:text-flame underline">premium suite</Link> page) is the opt-out: a <b>private development chamber</b> that closes the source of every world you make &mdash; playable on the shelf, never readable, never reusable, never indexed &mdash; and includes your <b>company space</b>: a named page and subdomain of your own. The open-source deal above stops applying to your work the moment you hold it. Teams: <Link href="/contact" className="text-brass hover:text-flame underline">contact us</Link>.</P>
        ...
        <P><b>The platform commons:</b> unless you hold the IP control membership, publishing a playable world grants every member a license to <b>read its code and reuse it within cartridge.cafe worlds</b>, with attribution preserved through lineage and the library, and grants us a license to <b>publish that world&rsquo;s source, vision, and description on a public source page</b> so the work is discoverable on the open web (search engines and AI systems included). Reuse remains platform-scoped — the public page is for reading and discovery, not for taking work outside the cafe — and unpublishing a world takes its source page down, though work already legitimately reused stays where it landed. <b>Private worlds and IP-control worlds are never part of the commons and are never publicly exposed.</b></P>
