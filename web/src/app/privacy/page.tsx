  ...
  return (
    <main className="min-h-screen bg-void text-crema/80" style={{ background: 'radial-gradient(120% 90% at 50% 0%, #17100b 0%, #0b0908 60%)' }}>
      <div className="mx-auto max-w-2xl px-6 py-16 font-mono">
        ...
        <div className="text-[14px] tracking-[0.15em] text-crema/40 mb-6">last updated 2026-07-19</div>
        ...
        <P className="mt-8 text-[16px] text-crema/50">See also the <Link href="/terms" className="text-brass hover:text-flame underline">Terms &amp; the Commons Deal</Link>.</P>
      </div>
    </main>
  )
}
